import { defaultFieldResolver, GraphQLArgument, GraphQLField, GraphQLInputField, print } from 'graphql'
...
export class Deprecated extends SchemaDirectiveVisitor {
  ...
  protected maybeLogToSplunk<T>(payload: T, logger: Logger = globalLogger) {
    ...
    const timeSinceLastLog = hrtimeToS([now[0] - lastLog[0], now[1] - lastLog[1]])

import { ACCOUNT, APP as APP_ENV, PUBLIC_ENDPOINT, WORKSPACE } from '../../../../constants'
...
export const formatPrivateRoute = ({
  protocol = 'https',
  vendor,
  name,
  major,

...
export class ErrorReport extends ErrorReportBase {
  ...
  public injectOnSpan(span: Span, logger?: IOContext['logger']) {
    ...
    if (
      ...
      span.setTag(TracingTags.ERROR_SERVER_CODE, this.parsedInfo.response.data)
      span.setTag(TracingTags.ERROR_SERVER_SOURCE, this.parsedInfo.response.data)
      span.setTag(TracingTags.ERROR_SERVER_REQUEST_ID, this.parsedInfo.response.data)
    }

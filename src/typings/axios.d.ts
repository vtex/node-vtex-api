// Definição de tipos personalizada para o Axios compatível com TypeScript 3.9.7
// Este arquivo substitui as definições padrão do Axios para garantir compatibilidade com TS 3.9.7

// Removendo a declaração original do módulo axios
// @ts-ignore
